...
```text
[主体人物与外观]，[发型与服装]，[姿态与动作]，位于[场景类型]；[环境细节]与[一个关键叙事道具]共同说明人物为何在此，并让观者看出刚发生或即将发生的[具体叙事触发点]。
...
[时间/天气]中明确的方向性主光，[主光方向]，果断的高对比电影明暗对照，清晰的受光面与背光面；画面中保留一块占据重要画面面积、可读的深色结构作为明暗锚点，人物、动作或关键元素跨越明暗分界，让光影直接服务[具体叙事触发点]；
暗部保持深度，避免压成纯黑，保留冷灰、蓝绿、橄榄或暖褐色相、少量反射光和必要结构，极少环境补光；
亮部收束为暖象牙白、银灰或淡暖色，只有太阳、玻璃、水面或金属反射等小面积高光接近纯白，避免大面积死白；
前景—人物—背景形成清晰空间层次，[构图]，[镜头]，建筑、天空、自然或城市空间承担叙事并可占据大部分画面；避免正中展示式构图，优先使用负空间、前景遮挡、环境压迫感或深色框景来突出故事关系；
[一到两项风、运动、反射或环境互动]，[主色 + 强调色]，画面像一个被时间冻结、没有明确开端和结局的故事中段：[氛围与叙事]；所有柔和色彩与笔触仍须保留清楚的高反差明暗组织，绝不使用均匀平光或泛白氛围代替叙事张力。
